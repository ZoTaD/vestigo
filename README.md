...
- **Cada juego es un chunk.** El JS de entrada es sólo la cáscara (barra, pie,
  idioma, rutas). Una pantalla de un juego se importa desde su área
  (`DeadlockArea.tsx`, `Poe2Area.tsx`, `Valheim.tsx`), nunca desde `App.tsx`.
